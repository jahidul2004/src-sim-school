...
const AtAGlance = () => {
    return (
        <div className="my-20">
            <div className="w-[95%] md:w-[80%] mx-auto flex items-center gap-4 md:gap-8">
                {/* Img div */}
                ...
                <div className="w-full md:w-1/2">
                    ...
                    <p className="my-5 leading-relaxed">
                        ...
                        soluta facilis aliquam vero voluptates commodi sunt
                        voluptatibus illo velit placeat dolorem beatae at ullam
                        laboriosam odio molestias adipisci totam, aperiam
                        eveniet! Dignissimos, eos. Eum reiciendis, soluta facere
                        ea fuga quidem. Lorem ipsum dolor sit amet consectetur
                        adipisicing elit. Corrupti vitae, repellat aperiam
                        expedita officiis enim ut nihil praesentium consequuntur
                        veniam? Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laboriosam, eligendi?
                    </p>
                    <Link
